...
--
-- Host: localhost
-- Generation Time: Nov 25, 2021 at 06:50 AM
...
--
-- Database: `detecting_fake_reviews`
--
CREATE DATABASE IF NOT EXISTS `detecting_fake_reviews` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `detecting_fake_reviews`;
...
--
-- Table structure for table `remote_user_review_prediction`
--

CREATE TABLE IF NOT EXISTS `remote_user_review_prediction` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
