"""detecting_fake_reviews  URL Configuration
...
from detecting_fake_reviews  import settings
...
urlpatterns = [
    ...
    url(r'^Product_Review_Type_Prediction/$', remoteuser.Product_Review_Type_Prediction, name="Product_Review_Type_Prediction"),
    ...
    url(r'^Find_Product_Review_Type_Ratio/$', serviceprovider.Find_Product_Review_Type_Ratio, name="Find_Product_Review_Type_Ratio"),
    url(r'^Train_Test_DataSets/$', serviceprovider.Train_Test_DataSets, name="Train_Test_DataSets"),
    url(r'^View_Predicted_Product_Review_Type/$', serviceprovider.View_Predicted_Product_Review_Type, name="View_Predicted_Product_Review_Type"),
